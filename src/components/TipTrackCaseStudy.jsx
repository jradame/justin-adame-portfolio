          ...
          <div className="grid gap-6 md:grid-cols-2">
            <article className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/70 hover:border-blue-400/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Bartenders earn inconsistent income from cash tips, credit tips, and
                mandatory tip-outs, but most still track earnings with memory, notes
                apps, or pen and paper. Without a clear view of real take-home pay,
                it's hard to budget, plan, or see whether shifts are truly worth it.
              </p>
            </article>
            ...
            <article className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/70 hover:border-blue-400/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                TipTrack is a mobile-first app that lets bartenders log a full shift in
                under 30 seconds, automatically calculate tip-outs, and instantly see
                true take-home pay. Clear weekly and monthly views help them spot
                patterns, choose better shifts, and feel in control of their money.
              </p>
            </article>
          </div>
        </section>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/70 hover:border-blue-400/50 transition-all duration-300 flex flex-col">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Started with quick sketches and low-fidelity wireframes to map the core
                flow: logging a shift, viewing weekly earnings, and comparing venues.
                This made it easy to test navigation, field order, and screen hierarchy
                with bartenders before investing in visual design.
              </p>
              <ul className="text-gray-300 text-sm space-y-2 mb-6 list-disc list-inside">
                <li>
                  Focused on a 30-second shift logging flow from first tap to saved
                  entry.
                </li>
                <li>Explored home layouts to surface weekly earnings and trends.</li>
                <li>
                  Compared tab vs. bottom navigation for faster access to key screens.
                </li>
              </ul>
              <div className="mt-auto">
                <img
                  src="/images/lofitiptrack.png"
            ...
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/70 hover:border-blue-400/50 transition-all duration-300 flex flex-col">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Refined the wireframes into a clean, production-ready UI using TipTrack
                branding, clear typography, and a green palette that reinforces
                financial growth. Screens highlight at-a-glance earnings, fast shift
                entry, and simple analytics.
              </p>
              <ul className="text-gray-300 text-sm space-y-2 mb-6 list-disc list-inside">
                <li>Clarified visual hierarchy for earnings vs. secondary stats.</li>
                <li>
                  Aligned colors and iconography with the "money clarity" concept.
                </li>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 text-center shadow-lg shadow-blue-400/40 hover:shadow-blue-400/70 hover:border-blue-400/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Pre-filled fields and smart defaults reduce entry time from 3+ minutes
                to under 30 seconds.
              </p>
            </div>
            ...
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 text-center shadow-lg shadow-blue-400/40 hover:shadow-blue-400/70 hover:border-blue-400/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Instant tip-out calculations show real take-home pay, eliminating
                manual math errors.
              </p>
            </div>
            ...
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 text-center shadow-lg shadow-blue-400/40 hover:shadow-blue-400/70 hover:border-blue-400/50 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Reliable income tracking enables effective budgeting and savings
                planning.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/60 transition-all duration-300">
              ...
              <p className="text-gray-300 text-base leading-relaxed">
                Shift logging time reduced by 90% with smart defaults and pre-filled
                fields.
              </p>
            </div>
            ...
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/60 transition-all duration-300">
              ...
              <p className="text-gray-300 text-base leading-relaxed">
                Bartenders can instantly see real take-home pay after tip-outs,
            ...
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/60 transition-all duration-300">
              ...
              <p className="text-gray-300 text-base leading-relaxed">
                Weekly and monthly earnings views help users identify profitable shifts
                and plan finances.
              </p>
            </div>
            ...
            <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-6 shadow-lg shadow-blue-400/40 hover:shadow-blue-400/60 transition-all duration-300">
              ...
              <p className="text-gray-300 text-base leading-relaxed">
                Automatic calculations eliminate manual math mistakes in tip-out
                tracking.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0a0f22] border border-gray-700 rounded-2xl p-8 shadow-lg shadow-blue-400/40">
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-gray-200 text-base leading-relaxed">
                    Conduct usability testing with 5–8 bartenders to validate the
                    design.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-gray-200 text-base leading-relaxed">
                    Iterate on the prototype based on real user feedback and pain
                    points.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-gray-200 text-base leading-relaxed">
                    Build an iOS/Android MVP with core features: shift logging,
                    tip-outs, and analytics.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-gray-200 text-base leading-relaxed">
                    Partner with restaurant management platforms for seamless
                    integration.
                  </p>
                </div>
              </div>
