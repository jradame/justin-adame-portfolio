...
const Hero = ({ loading }) => {
  ...
  return (
    <section className="w-full pt-24 pb-12 bg-black text-white">
      <div className="max-w-5xl w-full mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="w-40 h-40 flex-shrink-0 flex items-center justify-center">
          {loading ? (
            ...
            <div className="w-40 h-40 rounded-full ring-2 ring-indigo-400/70 shadow-[0_0_35px_rgba(96,165,250,0.45)] flex items-center justify-center">
              <img
          ...
          {loading ? (
            ...
            <>
              ...
              <p className="text-xl mb-2">
                I&apos;m a <span className="text-indigo-400 font-semibold">{text}</span>
